...
def save_figure(plt, name_prefix):
    ...
    filename = f'unpadded_{name_prefix}_{timestamp}.png'
...
# Set parameters
file_path = "./../../data/no_padding/single/single-data-1733308246890252800.csv"
chunk_size = 1000
test_size = 0.2
random_state = 42
...
fig.suptitle('Features vs num_included (Unpadded Certificates)', size=16, y=1.02)
...
plt.title('Actual vs Predicted Values (Unpadded Certificates)')
plt.tight_layout()
